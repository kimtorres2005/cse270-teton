...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1706, 986)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Blake")
    self.driver.find_element(By.NAME, "lname").send_keys("Torres")
    self.driver.find_element(By.NAME, "bizname").send_keys("T Pharmacy")
